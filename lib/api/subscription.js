...
class SubscriptionAPI extends api_wrapper_1.APIWrapper {
     ...
     */
    create(data) {
        return this.iugu.makeRequest('POST', '/subscriptions').begin(data);
    }
    /**
    ...
    get(subscription) {
        ...
        return this.iugu.makeRequest('GET', `/subscriptions/${id}`).begin();
    }
    /**
    ...
    activate(subscription) {
        ...
        return this.iugu.makeRequest('POST', `/subscriptions/${id}/activate`).begin();
    }
    /**
    ...
    suspend(subscription) {
        ...
        return this.iugu.makeRequest('POST', `/subscriptions/${id}/suspend`).begin();
    }
    /**
    ...
    update(subscription, newData) {
        ...
        return this.iugu.makeRequest('PUT', `/subscriptions/${id}`).begin(newData);
    }
    /**
    ...
    delete(subscription) {
        ...
        return this.iugu.makeRequest('DELETE', `/subscriptions/${id}`).begin();
    }
}
